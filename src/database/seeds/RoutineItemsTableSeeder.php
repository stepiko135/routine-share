    ...
    public function run()
    {
        DB::table('routine_items')->insert([
            ...
            [
                ...
                'time' => '07:10:00',
                'title' => 'スマホチェック',
                'desc' => '着替えたらそのままベッドでスマホのニュースをチェックします。ニュースを読んでる間に目が覚めてきます',
            ],
            [
                'user_id' => 3,
                'routine_id' => 3,
                'time' => '07:20:00',
                'title' => 'ひげ剃り、洗顔',
                'desc' => 'ひげ剃りをしてから、洗顔をします。肌が荒れがちなのでスキンケアは入念にします',
            ],
            [
                'user_id' => 3,
                'routine_id' => 3,
                'time' => '07:40:00',
                'title' => '朝ごはん',
                'desc' => '毎日、トースターとプロテイン１杯。これは完全に決まっています。食べるものが決めてあると時間が節約できます！',
            ],
            [
                'user_id' => 3,
                'routine_id' => 3,
